...
function Develop(){
    return(
        <div className='Develop'> 
            <h1 className="banner">Developing the Organization</h1>

            <h1 className='Title'>Building Collaborative Cultures</h1>
            <div className='container'>
             ...
             <h1 className='Title'>Connecting the school to the wider community</h1>
            <div className='container'>
                <ul>
