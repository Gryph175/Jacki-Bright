    ...
    return(
        <div>
            ...
            <div className='container'>
                ...
                <p className='par'>My first year as a teacher at Mac did not have any orientation or training prior to the start of the school year for new teachers to MacLachlan.  The following year along with a co-worker who also started with me we developed a two-day orientation program that I continue to deliver every August.</p>
            ...
            <div className='container'>
                ...
                <p className='par'>Learning never ends and I continue to expand my knowledge.</p>
                <p className='par'>AQ courses</p>
                <p className='par'>IB Workshops/Conferences</p>
                <p className='par'>2014 IB Conference of Americas Workshop Presenter in Chicago</p>
                <p className='par'>CIS Workshops</p>
                <p className='par'>Coaching 2019</p>
                <p className='par'>Unconference 2018</p>
